[x] ui colours ovetrhaul, I want to use a mixture of warm earthy colours, use the colours from this book cover: https://m.media-amazon.com/images/I/81g0AATkO9L._AC_UF1000,1000_QL80_.jpg
[x] dotted line, I want a dotted line that tracks the movement of oddysseus' ship between POIs, it should be flowy and look like a real ship movement trail across the ocean. The line turns solid when odysseus "passes the point on the map"
